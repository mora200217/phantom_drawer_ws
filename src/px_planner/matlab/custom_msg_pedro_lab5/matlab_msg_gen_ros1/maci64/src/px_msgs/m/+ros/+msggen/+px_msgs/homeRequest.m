...
classdef homeRequest < ros.Message
    %homeRequest MATLAB implementation of px_msgs/homeRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'px_msgs/homeRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.px_msgs.homeRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.px_msgs.homeRequest(strObj);
        end
    end
end
