function [data, info] = pxIkinemResponse
%pxIkinem gives an empty data for px_msgs/pxIkinemResponse
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'px_msgs/pxIkinemResponse';
[data.Config, info.Config] = ros.internal.ros.custommessages.px_msgs.pxConfig;
info.Config.MLdataType = 'struct';
info.MessageType = 'px_msgs/pxIkinemResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
