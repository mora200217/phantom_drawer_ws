...
classdef homeResponse < ros.Message
    %homeResponse MATLAB implementation of px_msgs/homeResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'px_msgs/homeResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.px_msgs.homeResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.px_msgs.homeResponse(strObj);
        end
    end
end
